"""
Django settings for djangoProjectSB project.
...
SECRET_KEY = 'django-insecure-6#_7c3^!r3cg$%gf0rp**wg99lf%ks4)j8=uk&nt%987@)b85c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True #для вывода ошибок на страницу. Если поставить False, то все статические файлы слетят, нужно дополнительно в настройках прописывать нестандартный путь. runserver --insecure пишем в manage.py и в режиме False дается новый адрес и можно смотреть и править сайт
...
INSTALLED_APPS = [
    ...
    'sitewomen.apps.SitewomenConfig',
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware', # для джангодебага
]

ROOT_URLCONF = 'djangoProjectSB.urls'
...
WSGI_APPLICATION = 'djangoProjectSB.wsgi.application'
...
STATIC_URL = 'static/'
# STATICFILES_DIRS = [BASE_DIR / 'sitewomen/../djangoProjectSB/../sitewomen/static'] # это путь для нестандартного размещения папки со статиками
...
LOGIN_REDIRECT_URL = 'home' # для перенаправления юзера после регистрации в системе на определенную страницу
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # для отправки письма типа почтового, но в консоль